    ...
    <ThemeProvider theme={darkTheme}>
      <div className='flex pt-20 justify-center'>
        <div className='basis-5/12'>
          <div className='text-4xl text-white font-bold mb-10 text-center'>Để tiếp tục hãy đăng nhập vào Spotify.</div>
          <div className='mt-5'>
          ...
          <div className="mt-8 flex justify-center">
            <div onClick={loginHandler} className='bg-emerald-600 hover:bg-emerald-400 duration-300 py-4 px-20 text-2xl font-bold text-black rounded-full cursor-pointer'>Đăng nhập</div>
          </div>
        </div>
      </div>
    </ThemeProvider>
